...
http://172.25.19.164:631/printers/HP_LaserJet_1020
...
2. 服务端驱动损坏。修复过程：连接ssh a1023@172.25.19.164，密码私聊问我，登录上之后有一个driver文件夹,复制执行./hplip-3.21.10.run（已给权限，该账户没有管理员权限），等待安装完成，再次尝试打印。